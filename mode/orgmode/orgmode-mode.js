(function(mod) {
    ...
    CodeMirror.registerHelper("fold", "neorg", function(cm, start) {
        // init
    ...
    CodeMirror.registerGlobalHelper("fold", "drawer", function(mode) {
        return mode.name === 'neorg' ? true : false;
    }, function(cm, start) {
    ...
    CodeMirror.registerHelper("neorg", "init", (editor, fn) => {
        ...
        return CodeMirror.neorg.destroy.bind(this, editor);
    });

    CodeMirror.registerHelper("neorg", "destroy", (editor) => {
    ...
    CodeMirror.defineMIME("text/norg", "norg");
});
